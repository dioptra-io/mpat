...
func runIrisResults(destTable string, policy store.StorePolicy, tableFlag, measurement, fromStr, toStr, stateStr, tagPattern string, chunkSize int64, ewmaAlpha float64) error {
	modes := 0
	if tableFlag != "" {
		modes++
	}
